...
//let words = ['touch your nose','stretch up high','clap your hands','bend down','shake your body','lift your leg','wave your arms','stomp your feet','spin around']
...
//let words = ['sunny','partly cloudy','cloudy','rainy','drizzling','stormy','snowy','sleeting','hailing','foggy','windy','frosty','warm','cold','hot','humid','wet','dry','cool'];
//let words = ['rain','grass','water','droplet','air','cloud','heavy','garden','vapor'];
...
//let words = ['dishwasher','lamp','candle','microwave','broom','kettle','washing','machine','vacuum','cleaner'];
//let words = ['history','study','place','people','question','answer','internet','object','museum','past','present','future'];
//let words = ['hair','long','straight','curly','short','beard','mustache','blond','black','glasses'];
...
//let words = ['snake','bat','bird','dolphin','crocodile','cave','sky','ocean','jungle','river'];
//let words = ['snorkeling','surfing','rock climbing','sailing','horse riding','mountain biking'];
...
//let words = ['bike','block','ball','kite','marble','basketball','skateboard','boat','plane','toy','doll', 'football','soccer ball','guitar','toy box'];
...
//let words = ['hat','dress','cap','scarf','shirt','jacket','skirt','pants','socks','shoes','coat','sweater','shoes'];
