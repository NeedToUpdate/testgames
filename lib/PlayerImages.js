...
let characters = [
    ...
    'peppapig', 'spongebob', 'monkey', 'tiger', 
    'shark', 'cinderella', 'elsa', 'ariel', 
    'deadfish', 'mrkrabs', 'thanos', 'pikachu', 
    'drstrange', 'superman', 'genie', 'simba', 
    'captainmarvel', 'mewtwo', 'sailormoon', 'venom', 
    'thor', 'ultraman2', 'ultraman3', 'olaf', 
    'hulk', 'gundam', 'optimus', 'snowwhite', 
    'deadpool', 'goku', 'ash', 'charizard', 
    'captainamerica', 'nakoruru', 'mario', 'emmet', 
    'wyldstyle', 'tree', 'link', 'isabelle', 
    'doraemon', 'hellokitty', 'penguin','rainbow',
    'zebra','sofia', 'baby', 'starfish', 
    'bananaman' , 'arlo' , 'blackwidow' , 'shrek', 
    'batman', 'hawkeye', 'hermione','harrypotter',
    'sleepingbeauty','rapunzel','vision', 'squirtle',
    'anna','sunwukong','shoe','arceus'
];
let powers = [
