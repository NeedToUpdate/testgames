let characters = [
    ...
    'baby', 'starfish', 'bananaman' , 'arlo' , 'blackwidow' , 'shrek', 'batman', 'hawkeye',
    'hermione','harrypotter','sleepingbeauty','rapunzel','vision'
];
let powers = [
    'blueenergy',
    'web', 'bluebeam', 'fire',
    ...
    'water', 'stars' , 'banana', 'rock' , 'grenade', 'onion', 'blackenergy', 'arrow',
    'greenenergy','whitemagic','pinkenergy','hairbrush','yellowmagic'
];
