    ...
    update(time) {
        ...
        if(arguments.length<1){
            ...
            while(this.deltaTaccumulator>= this.maxDeltaT){
                ...
                // console.log('dt, accum, dt>acum', this.maxDeltaT, this.deltaTaccumulator, this.deltaTaccumulator>= this.maxDeltaT)
                //position calcs
                dt = this.maxDeltaT/20
                if(this.dead) break;
                this.subroutines.forEach(name => {
                ...
                this.v.limit(this.MAX_V)
                this.old_p = this.p.copy()
                this.p.add(this.v.copy().add(this.old_v).mult(dt/2));
                this.a.clear();
                ...
                // console.log('delta_accumilator ' + this.deltaTaccumulator.toPrecision(3))
            }
