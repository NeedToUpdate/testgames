...
class Arrow extends LineFromPoints{
    ...
    createArrow(){
        this.leftSide = new LineFromAngle(0,0,this.thickness*10,this.theta-30,this.thickness);
        this.attach(this.leftSide);
        this.rightSide = new LineFromAngle(0,0,this.thickness*10,this.theta+300,this.thickness);
