...
class Arrow extends LineFromPoints{
    ...
    createArrow(){
        let line = new LineFromAngle(0,0,this.thickness*10,this.theta-30,this.thickness)
        this.attach(line)
        let line2 = new LineFromAngle(0,0,this.thickness*10,this.theta+300,this.thickness)
        this.attach(line2)
    }
}
