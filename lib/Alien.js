    ...
    doTaunt() {
        if(this.isDoingTaunt){
            ...
            if(checkObj(letter)){
                ...
                this.MAX_V = mapNum(last_move.mag,0,25,this._DEFAULT_MAX_V/2,this._DEFAULT_MAX_V*1.1) //trial and error's numbers. maybe better way to figure this out
                this.MAX_F = mapNum(last_move.mag,0,25,this._DEFAULT_MAX_F/2,this._DEFAULT_MAX_F*1.1)
                this.pathTo(targetV);
            }
        }else{
            return new Promise(resolve=>{
